...
/**
 * External function to get Stripe config for JS.
 *
...
class get_config_for_js extends external_api {
    ...
    /**
     * Returns the config values required by the Stripe JavaScript.
     *
    ...
    public static function execute(string $component, string $paymentarea, int $itemid): array {
        ...
        $config = helper::get_gateway_configuration($component, $paymentarea, $itemid, 'stripe');
    ...
    public static function execute_returns(): external_single_structure {
        return new external_single_structure([
            'publishablekey' => new external_value(PARAM_TEXT, 'Stripe publishable key'),
